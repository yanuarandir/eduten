...
<head>
    ...
    <title>Dashboard &mdash; Eduten</title>
        ...
        <div class="main-wrapper main-wrapper-1">
            ...
            <div class="main-sidebar sidebar-style-2">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="{{ route('dashboard.index') }}">Eduten APP</a>
                    </div>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        @can('subjects.index')
                        <li class="{{ setActive('/students') }}"><a class="nav-link"
                                href="{{ route('students.index') }}"><i class="fas fa-atlas"></i>
                                <span>Result Exam</span></a></li>
                        @endcan
            ...
            <footer class="main-footer">
                <div class="footer-left">
                    Copyright &copy; 
                        {{ date("Y"); }}
                     <div class="bullet"></div> Eduten APP <div class="bullet"></div> All Rights
                    Reserved.
                </div>
